    ...
    >
      ...
      >
        ...
        <div className="mt-4 text-center">
          <p className="text-white font-display text-[16px] font-semibold">{photo.title}</p>
...
export default function Gallery() {
  ...
  const filtered = useMemo(
    () => (activeCategory === 'All' ? photos : photos.filter((p) => p.type === activeCategory)),
    [activeCategory]
  )
    ...
    <section className="bg-[#FFF9F3] py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="text-center max-w-2xl mx-auto">
          <p className="text-[13px] font-semibold tracking-[0.14em] text-[#0F8B8D]">GALLERY</p>
          <h1 className="mt-3 font-display text-[30px] sm:text-[40px] leading-[1.15] font-semibold text-[#063B5C]">
            ...
            {filtered.map((photo, i) => {
              ...
              return (
                <button
                  ...
                  className={`group relative block w-full mb-4 rounded-2xl overflow-hidden bg-[#EDF1F5] break-inside-avoid ${
