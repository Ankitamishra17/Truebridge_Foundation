          ...
          >
            <motion.img
              ...
              className={`
                ...
                ${
                  scrolled
                    ? "w-14 h-14 lg:scale-125"
                    : "w-16 h-16 lg:scale-[1.35]"
                }
              `}
            />
          </NavLink>
              ...
              >
                <button
                  ...
                  className="
                    ...
                    font-semibold
                    hover:brightness-105
                    hover:shadow-[0_10px_24px_-6px_rgba(255,102,52,0.4)]
                    transition-all
                    outline-none
                    focus-visible:ring-2
                    focus-visible:ring-[#ff6634]/40
