...
export default function AboutHero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#FDFBF7] via-[#FDFBF7]/85 sm:via-[#FDFBF7]/70 to-transparent" />
      ...
      <Container className="relative pt-14 sm:pt-20 pb-16 sm:pb-24">
        ...
        >
          ...
          <h1 className="mt-3 font-display text-[34px] sm:text-[40px]  leading-[1.1] font-semibold text-[#063B5C]">
            A neighbourhood foundation built on health camps, honest
