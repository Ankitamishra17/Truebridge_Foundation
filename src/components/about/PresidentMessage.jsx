      ...
      <Container className="py-16 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* name badge */}
            <div className="absolute left-5 -bottom-6 bg-white rounded-2xl shadow-[0_12px_30px_rgba(6,59,92,0.15)] px-5 py-3">
              <p className="font-display font-semibold text-[15px] text-[#063B5C]">
                Mayank Bansal
              </p>
              <p className="text-[13px] text-[#64748B]">President</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative mt-6">
              <span className="absolute -top-3 -left-1 font-display text-5xl text-[#0F8B8D]/25 select-none">
                &ldquo;
              </span>
              <p className="relative pl-6 text-[15px] leading-relaxed text-[#475569]">
              ...
              <span className="absolute -bottom-6 right-0 font-display text-5xl text-[#0F8B8D]/25 select-none">
                &rdquo;
              </span>
            </div>
            ...
            <div className="mt-10 flex flex-wrap items-center justify-between gap-6">
              <a
                ...
                className="inline-flex items-center gap-2.5 bg-[#FF6B4A] text-white rounded-md pl-2 pr-5 py-2 text-[14px] font-semibold hover:brightness-105 transition"
              >
              ...
              <p className="text-right text-[14px] text-[#063B5C]">
                <span className="font-display font-semibold">— Mayank Bansal</span>
                <br />
                <span className="text-[#64748B]">President</span>
              </p>
            </div>
          </motion.div>
        </div>
