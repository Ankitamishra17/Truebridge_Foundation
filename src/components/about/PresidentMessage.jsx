      ...
      <Container className="py-16 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <svg
              className="absolute -bottom-8 -left-10 w-56 h-56 text-[#E8F7EF] -z-10"
              viewBox="0 0 200 200"
              fill="currentColor"
            >
            ...
            <svg
              className="absolute -top-6 -right-8 w-28 h-28 text-[#FFF0EB] -z-10"
              viewBox="0 0 200 200"
              fill="currentColor"
            >
            ...
            {/* name badge */}
            <div className="absolute left-5 -bottom-6 flex items-center gap-2 bg-white rounded-2xl shadow-[0_12px_30px_rgba(62,64,149,0.15)] px-5 py-3">
          ...
          >
            ...
            <div className="relative mt-7 bg-[#FFF9F3] rounded-2xl border-l-4 border-[#00a85a] p-6 sm:p-7 overflow-hidden">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-between gap-6">
              <a
                ...
                className="group inline-flex items-center gap-2.5 bg-[#ff6634] text-white rounded-md pl-2 pr-5 py-2 text-[14px] font-semibold hover:brightness-105 transition"
              >
