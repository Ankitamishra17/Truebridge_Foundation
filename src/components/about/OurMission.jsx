    ...
    <section className="bg-[#FFF9F3]">
      <Container className="py-16 sm:py-20">
        <div className="text-center max-w-xl mx-auto">
          ...
          <h2 className="mt-4 font-display text-[26px] sm:text-[32px] font-semibold text-[#3e4095] leading-tight">
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-white rounded-2xl border border-[#E6E7F2] p-6 sm:p-7 flex flex-col items-center text-center overflow-hidden shadow-[0_1px_2px_rgba(62,64,149,0.04)] hover:shadow-[0_12px_28px_-10px_rgba(62,64,149,0.18)] hover:-translate-y-1 transition-all duration-300"
              >
                {/* Top accent bar */}
                <span
                ...
                <h3 className="mt-5 font-display font-semibold text-[16px] sm:text-[17px] text-[#3e4095]">
                  {item.title}
                </h3>
